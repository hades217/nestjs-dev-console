...
exports.devConsoleEnabled = devConsoleEnabled;
 ...
 */
function devConsoleEnabled(opts = {}, env = process.env) {
    if (env.DEV_CONSOLE_ENABLED === 'false')
        return false;
 ...
 */
function resolveEnabled(config, env = process.env) {
    if (env.DEV_CONSOLE_ENABLED === 'false')
        return false;
